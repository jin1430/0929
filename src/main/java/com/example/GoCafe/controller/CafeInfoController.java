...
public class CafeInfoController {
    ...
    public String upsert(@PathVariable Long cafeId,
        ...
        entity.setNotice(trim(form.getNotice(), 20));
        entity.setCafeInfo(trim(form.getCafeInfo(), 500));
        entity.setOpenTime(trim(form.getOpenTime(), 7));
        entity.setCloseTime(trim(form.getCloseTime(), 7));
        entity.setHoliday(trim(form.getHoliday(), 7));
